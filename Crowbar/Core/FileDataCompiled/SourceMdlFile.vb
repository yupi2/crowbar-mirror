...
#Region "Methods"
	...
	Public Overridable Sub ReadFileHeader(ByVal inputPathFileName As String, ByVal aMdlFileData As SourceMdlFileHeader)
	...
	Public Overridable Sub ReadFileForViewer(ByVal inputPathFileName As String, ByVal aMdlFileData As SourceMdlFileHeader)
		Dim inputFileStream As FileStream = Nothing
		Me.theInputFileReader = Nothing
		Try
			inputFileStream = New FileStream(inputPathFileName, FileMode.Open)
		...
		Try
			...
			If inputFileStream IsNot Nothing Then
				Try
					...
					Me.theMdlFileData = New SourceMdlFileHeader()
					Me.ReadMdlHeader00("")
...
#Region "Data"
	...
	Protected theMdlFileData As SourceMdlFileHeader
	Protected theInputFileReader As BinaryReader

	'Private theCurrentFrameIndex As Integer
