Public Class SourceMdlFileHeader
	...
	' VERSION 44:
	'NOTE: Based on the comment and the value for the constant being different for v48, this might not have been used until v48.
	'// Flag to mark delta flexes as already converted from disk format to memory format
