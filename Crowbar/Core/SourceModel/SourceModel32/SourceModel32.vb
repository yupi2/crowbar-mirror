...
#Region "Private Methods"
	...
	Protected Overrides Sub WriteQcFile()
		Dim qcFile As New SourceQcFile32(Me.theOutputFileTextWriter, Me.theQcPathFileName, Me.theMdlFileData, Me.thePhyFileData, Me.theVtxFileData, Me.theName)
	...
	Protected Overrides Sub WritePhysicsMeshSmdFile()
		Dim physicsMeshSmdFile As New SourceSmdFile32(Me.theOutputFileTextWriter, Me.theMdlFileData, Me.thePhyFileData)
