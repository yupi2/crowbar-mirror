...
#Region "Methods"
	...
	Public Sub ReadFile(ByVal inputPathFileName As String, ByVal aSourceEngineModel As SourceModel_Old)
		...
		'inputPathFileName = Path.ChangeExtension(pathFileName, ".vtx")
		'If Not File.Exists(inputPathFileName) Then
		'	inputPathFileName = Path.ChangeExtension(pathFileName, ".dx90.vtx")
		'	If Not File.Exists(inputPathFileName) Then
		'		inputPathFileName = Path.ChangeExtension(pathFileName, ".dx80.vtx")
		'		If Not File.Exists(inputPathFileName) Then
		'			inputPathFileName = Path.ChangeExtension(pathFileName, ".sw.vtx")
		'			If Not File.Exists(inputPathFileName) Then
		'				Return
		'			End If
		'		End If
		...
		Try
			...
			If inputFileStream IsNot Nothing Then
				Try
					...
					Me.ReadSourceVtxHeader()
					If Me.theSourceEngineModel.VtxFileHeader.lodCount > 0 Then
...
#Region "Private Methods"
	...
	Private Sub ReadSourceVtxHeader()
		Me.theSourceEngineModel.VtxFileHeader = New SourceVtxFileData()

		' Offset: 0x00
		Me.theSourceEngineModel.VtxFileHeader.version = Me.theInputFileReader.ReadInt32()

		' Offsets: 0x04, 0x08, 0x0A (10), 0x0C (12)
		Me.theSourceEngineModel.VtxFileHeader.vertexCacheSize = Me.theInputFileReader.ReadInt32()
		Me.theSourceEngineModel.VtxFileHeader.maxBonesPerStrip = Me.theInputFileReader.ReadUInt16()
		Me.theSourceEngineModel.VtxFileHeader.maxBonesPerTri = Me.theInputFileReader.ReadUInt16()
		Me.theSourceEngineModel.VtxFileHeader.maxBonesPerVertex = Me.theInputFileReader.ReadInt32()

		' Offset: 0x10 (16)
		Me.theSourceEngineModel.VtxFileHeader.checksum = Me.theInputFileReader.ReadInt32()

		' Offset: 0x14 (20)
		Me.theSourceEngineModel.VtxFileHeader.lodCount = Me.theInputFileReader.ReadInt32()

		' Offset: 0x18 (24)
		Me.theSourceEngineModel.VtxFileHeader.materialReplacementListOffset = Me.theInputFileReader.ReadInt32()

		' Offsets: 0x1C (28), 0x20 (32)
		Me.theSourceEngineModel.VtxFileHeader.bodyPartCount = Me.theInputFileReader.ReadInt32()
		Me.theSourceEngineModel.VtxFileHeader.bodyPartOffset = Me.theInputFileReader.ReadInt32()
	End Sub

	Private Sub ReadSourceVtxBodyParts()
		If Me.theSourceEngineModel.VtxFileHeader.bodyPartCount > 0 Then
			Dim bodyPartInputFileStreamPosition As Long
			Dim inputFileStreamPosition As Long

			Try
				Me.theInputFileReader.BaseStream.Seek(Me.theSourceEngineModel.VtxFileHeader.bodyPartOffset, SeekOrigin.Begin)
				Me.theSourceEngineModel.VtxFileHeader.theVtxBodyParts = New List(Of SourceVtxBodyPart)(Me.theSourceEngineModel.VtxFileHeader.bodyPartCount)
				For i As Integer = 0 To Me.theSourceEngineModel.VtxFileHeader.bodyPartCount - 1
					...
					Me.theSourceEngineModel.VtxFileHeader.theVtxBodyParts.Add(aBodyPart)
