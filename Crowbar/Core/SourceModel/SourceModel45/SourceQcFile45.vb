...
#Region "Creation and Destruction"
	...
	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal outputPathFileName As String, ByVal mdlFileData As SourceMdlFileData45, ByVal vtxFileData As SourceVtxFileData45, ByVal phyFileData As SourcePhyFileData45, ByVal aniFileData As SourceAniFileData45, ByVal modelName As String)
