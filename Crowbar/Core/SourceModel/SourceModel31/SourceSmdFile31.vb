...
#Region "Methods"
	...
	'Public Sub WriteSkeletonSectionForAnimation(ByVal aSequenceDescBase As SourceMdlSequenceDescBase, ByVal blendIndex As Integer)
	'	Dim line As String = ""
	'	Dim boneIndex As Integer
	'	Dim aFrameLine As AnimationFrameLine
...
#Region "Private Methods"
	...
	'Private Sub CalcAnimation(ByVal aSequenceDesc As SourceMdlSequenceDesc31, ByVal blendIndex As Integer, ByVal frameIndex As Integer)
	'	Dim s As Double
	...
	Public Function ExtractAnimValue(ByVal frameIndex As Integer, ByVal animValues As List(Of SourceMdlAnimationValue), ByVal scale As Double, ByVal adjustment As Double) As Double
		Dim v1 As Double
