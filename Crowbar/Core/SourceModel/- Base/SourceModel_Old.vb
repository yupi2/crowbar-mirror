...
Public Class SourceModel_Old

#Region "Properties"

	Public Property PhyFileHeader As SourcePhyFileData
		Get
			Return Me.thePhyFileHeader
		End Get
		Set(ByVal value As SourcePhyFileData)
			Me.thePhyFileHeader = value
		End Set
	End Property

	Public Property MdlFileHeader As SourceMdlFileData
		Get
			Return Me.theMdlFileHeader
		End Get
		Set(ByVal value As SourceMdlFileData)
			Me.theMdlFileHeader = value
		End Set
	End Property

	Public Property AniFileHeader As SourceAniFileData
		Get
			Return Me.theAniFileHeader
		End Get
		Set(ByVal value As SourceAniFileData)
			Me.theAniFileHeader = value
		End Set
	End Property

	Public Property VtxFileHeader As SourceVtxFileData
		Get
			Return Me.theVtxFileHeader
		End Get
		Set(ByVal value As SourceVtxFileData)
			Me.theVtxFileHeader = value
		End Set
	End Property

	Public Property VvdFileHeader As SourceVvdFileData
		Get
			Return Me.theVvdFileHeader
		End Get
		Set(ByVal value As SourceVvdFileData)
...
#Region "Data"
	...
	Private thePhyFileHeader As SourcePhyFileData
	Private theMdlFileHeader As SourceMdlFileData
	Private theAniFileHeader As SourceAniFileData
	Private theVtxFileHeader As SourceVtxFileData
	Private theVvdFileHeader As SourceVvdFileData
