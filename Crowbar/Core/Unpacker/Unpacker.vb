...
#Region "Create and Destroy"
	...
	Public Sub New()
		...
		Me.theUnpackedTempPathsAndPathFileNames = New BindingListEx(Of String)()
...
#Region "Private Methods in Background Thread"
	...
	Private Sub UpdateProgressInternal(ByVal progressValue As Integer, ByVal line As String)
		...
		If progressValue = 3 AndAlso Me.theLogFileStream IsNot Nothing Then
	...
	Private Sub ExtractFromArchive(ByVal archiveDirectoryPathFileName As String, ByVal archivePathFileNameToEntryIndexMap As SortedList(Of String, List(Of Integer)))
		Try
			Dim vpkPath As String
			Dim vpkFileName As String
			Dim vpkRelativePath As String
...
#Region "Data"
	...
	'TODO: Not currently used for anything.
	Private theUnpackedTempPathsAndPathFileNames As BindingListEx(Of String)
