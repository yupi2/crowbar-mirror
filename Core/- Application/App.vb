...
#Region "Init and Free"
	...
	Public Sub Init()
		...
		Me.theModelViewer = New ModelViewer()
	End Sub
...
#Region "Properties"
	...
	Public ReadOnly Property ModelViewer() As ModelViewer
		Get
...
#Region "Methods"
	...
	Public Function GetLogsPath(ByVal outputPath As String, ByVal modelName As String) As String
...
#Region "Private Methods"
	...
	Private Sub CreateAppSettings()
		...
		'Me.theSettings.SelectedGameSetup = gameSetup.GameName
		Me.theSettings.SelectedGameSetupIndex = 0
...
#Region "Data"
	...
	Private theModelViewer As ModelViewer
