...
#Region "Write Log File Methods"
	...
	Public Sub WriteFile(ByVal pathFileName As String, ByVal aSourceEngineModel As SourceModel)
		...
		Try
			...
			Me.WriteMdlFileInfo(Me.theSourceEngineModel.theMdlFileHeader)
			'Me.WritePhyFileInfo()
			'Me.WriteVtxFileInfo()
...
#Region "Write PHY-File Related"
	...
	Private Sub WritePhyFileInfo()
		If Me.theSourceEngineModel.thePhyFileHeader Is Nothing Then
			Exit Sub
		End If
	...
	Private Sub WriteSourcePhyHeader()
		...
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("00 size", Me.theSourceEngineModel.thePhyFileHeader.size))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("04 id", Me.theSourceEngineModel.thePhyFileHeader.id))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerLine("08 solidCount", Me.theSourceEngineModel.thePhyFileHeader.solidCount))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerAsHexLine("0C checksum", Me.theSourceEngineModel.thePhyFileHeader.checksum))
	...
	Private Sub WritePhyKeyValueDataStartOffset()
		...
		Me.WriteLogLine(0, DebugFormatModule.FormatLongWithHexLine("offset", Me.theSourceEngineModel.thePhyFileHeader.theSourcePhyKeyValueDataOffset))
	...
	Private Sub WriteSourcePhysCollsionModels()
		If Me.theSourceEngineModel.thePhyFileHeader.theSourcePhyPhysCollisionModels IsNot Nothing Then
			Dim line As String
	...
	Private Sub WriteSourcePhyRagdollConstraintDescs()
		If Me.theSourceEngineModel.thePhyFileHeader.theSourcePhyRagdollConstraintDescs IsNot Nothing Then
			Dim line As String
			...
			For i As Integer = 0 To Me.theSourceEngineModel.thePhyFileHeader.theSourcePhyRagdollConstraintDescs.Count - 1
				aSourceRagdollConstraintDesc = Me.theSourceEngineModel.thePhyFileHeader.theSourcePhyRagdollConstraintDescs.Values(i)
	...
	Private Sub WriteSourcePhyCollisionPairs()
		If Me.theSourceEngineModel.thePhyFileHeader.theSourcePhyCollisionPairs IsNot Nothing Then
			Dim line As String
			...
			For i As Integer = 0 To Me.theSourceEngineModel.thePhyFileHeader.theSourcePhyCollisionPairs.Count - 1
				aSourcePhyCollisionPair = Me.theSourceEngineModel.thePhyFileHeader.theSourcePhyCollisionPairs(i)
...
#Region "Write VTX-File Related"
	...
	Private Sub WriteVtxHeader()
		...
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("00 version", Me.theSourceEngineModel.theVtxFileHeader.version))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("04 vertexCacheSize", Me.theSourceEngineModel.theVtxFileHeader.vertexCacheSize))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("08 maxBonesPerStrip", Me.theSourceEngineModel.theVtxFileHeader.maxBonesPerStrip))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("0A maxBonesPerTri", Me.theSourceEngineModel.theVtxFileHeader.maxBonesPerTri))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("0C maxBonesPerVertex", Me.theSourceEngineModel.theVtxFileHeader.maxBonesPerVertex))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("10 checksum", Me.theSourceEngineModel.theVtxFileHeader.checksum))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerLine("14 lodCount", Me.theSourceEngineModel.theVtxFileHeader.lodCount))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("18 materialReplacementListOffset", Me.theSourceEngineModel.theVtxFileHeader.materialReplacementListOffset))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerLine("1C bodyPartCount", Me.theSourceEngineModel.theVtxFileHeader.bodyPartCount))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("20 bodyPartOffset", Me.theSourceEngineModel.theVtxFileHeader.bodyPartOffset))
	...
	Private Sub WriteVtxBodyParts()
		...
		If Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts IsNot Nothing Then
			...
			For i As Integer = 0 To Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts.Count - 1
				Dim aBodyPart As SourceVtxBodyPart
				aBodyPart = Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts(i)
	...
	Private Sub WriteVtxBodyPartsCalculatedOffsets()
		...
		If Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts IsNot Nothing Then
			...
			line = "====== Vtx Body Parts ======"
			Me.WriteLogLine(0, line)
			Me.WriteLogLine(0, DebugFormatModule.FormatIntegerLine("BodyPart count", Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts.Count))

			addressStart = Me.theSourceEngineModel.theVtxFileHeader.bodyPartOffset
			For i As Integer = 0 To Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts.Count - 1
				Dim aBodyPart As SourceVtxBodyPart
				aBodyPart = Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts(i)
	...
	Private Sub WriteVtxFileInfoCalculatedOffsets2()
		...
		addressStart = Me.theSourceEngineModel.theVtxFileHeader.bodyPartOffset
		bodyPartCount = Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts.Count
...
#Region "Write VVD-File Related"
	...
	Private Sub WriteVvdData()
		...
		Me.WriteLogLine(0, DebugFormatModule.FormatStringLine("00 id", Me.theSourceEngineModel.theVvdFileHeader.id))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerLine("04 version", Me.theSourceEngineModel.theVvdFileHeader.version))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("08 checksum", Me.theSourceEngineModel.theVvdFileHeader.checksum))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerLine("0C lodCount", Me.theSourceEngineModel.theVvdFileHeader.lodCount))
		For i As Integer = 0 To Me.theSourceEngineModel.theVvdFileHeader.lodVertexCount.Length - 1
			Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("lodVertexCount(" + i.ToString() + ")", Me.theSourceEngineModel.theVvdFileHeader.lodVertexCount(i)))
		Next
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerLine("fixupCount", Me.theSourceEngineModel.theVvdFileHeader.fixupCount))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("fixupTableOffset", Me.theSourceEngineModel.theVvdFileHeader.fixupTableOffset))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("vertexDataOffset", Me.theSourceEngineModel.theVvdFileHeader.vertexDataOffset))
		Me.WriteLogLine(0, DebugFormatModule.FormatIntegerWithHexLine("tangentDataOffset", Me.theSourceEngineModel.theVvdFileHeader.tangentDataOffset))
	...
	Private Sub WriteVvdFixups()
		...
		If Me.theSourceEngineModel.theVvdFileHeader.theFixups IsNot Nothing Then
			Me.WriteLogLine(1, "")
			Me.WriteLogLine(1, "")
			line = "====== Vvd Fixups ======"
			Me.WriteLogLine(1, line)
	...
	Private Sub WriteVvdVertexes()
		...
		If Me.theSourceEngineModel.theVvdFileHeader.theVertexes IsNot Nothing Then
			Me.WriteLogLine(1, "")
			Me.WriteLogLine(1, "")
			line = "====== Vvd Vertexes ======"
			Me.WriteLogLine(1, line)

			For k As Integer = 0 To Me.theSourceEngineModel.theVvdFileHeader.theVertexes.Count - 1
				Dim aVertex As SourceVertex
				aVertex = Me.theSourceEngineModel.theVvdFileHeader.theVertexes(k)
