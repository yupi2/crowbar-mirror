			...
			For i As Integer = 0 To theSourceEngineModel.theMdlFileHeader.theBones.Count - 1
				...
				If aBone.proceduralRuleOffset <> 0 Then
					...
					ElseIf aBone.proceduralRuleType = SourceMdlBone.STUDIO_PROC_QUATINTERP Then
						...
						aParentBone = theSourceEngineModel.theMdlFileHeader.theBones(aBone.parentBoneIndex)
						aControlBone = theSourceEngineModel.theMdlFileHeader.theBones(aBone.theQuatInterpBone.controlBoneIndex)
						aParentControlBone = theSourceEngineModel.theMdlFileHeader.theBones(aControlBone.parentBoneIndex)
