...
#Region "Private Methods"
	...
	Private Sub ReadSourceVtxHeader()
		Me.theSourceEngineModel.theVtxFileHeader = New SourceVtxFileHeader()

		' Offset: 0x00
		Me.theSourceEngineModel.theVtxFileHeader.version = Me.theInputFileReader.ReadInt32()

		' Offsets: 0x04, 0x08, 0x0A (10), 0x0C (12)
		Me.theSourceEngineModel.theVtxFileHeader.vertexCacheSize = Me.theInputFileReader.ReadInt32()
		Me.theSourceEngineModel.theVtxFileHeader.maxBonesPerStrip = Me.theInputFileReader.ReadUInt16()
		Me.theSourceEngineModel.theVtxFileHeader.maxBonesPerTri = Me.theInputFileReader.ReadUInt16()
		Me.theSourceEngineModel.theVtxFileHeader.maxBonesPerVertex = Me.theInputFileReader.ReadInt32()

		' Offset: 0x10 (16)
		Me.theSourceEngineModel.theVtxFileHeader.checksum = Me.theInputFileReader.ReadInt32()

		' Offset: 0x14 (20)
		Me.theSourceEngineModel.theVtxFileHeader.lodCount = Me.theInputFileReader.ReadInt32()

		' Offset: 0x18 (24)
		Me.theSourceEngineModel.theVtxFileHeader.materialReplacementListOffset = Me.theInputFileReader.ReadInt32()

		' Offsets: 0x1C (28), 0x20 (32)
		Me.theSourceEngineModel.theVtxFileHeader.bodyPartCount = Me.theInputFileReader.ReadInt32()
		Me.theSourceEngineModel.theVtxFileHeader.bodyPartOffset = Me.theInputFileReader.ReadInt32()
	End Sub

	Private Sub ReadSourceVtxBodyParts()
		If Me.theSourceEngineModel.theVtxFileHeader.bodyPartCount > 0 Then
			Dim bodyPartInputFileStreamPosition As Long
			Dim inputFileStreamPosition As Long

			Try
				Me.theInputFileReader.BaseStream.Seek(Me.theSourceEngineModel.theVtxFileHeader.bodyPartOffset, SeekOrigin.Begin)
				Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts = New List(Of SourceVtxBodyPart)(Me.theSourceEngineModel.theVtxFileHeader.bodyPartCount)
				For i As Integer = 0 To Me.theSourceEngineModel.theVtxFileHeader.bodyPartCount - 1
					...
					Me.theSourceEngineModel.theVtxFileHeader.theVtxBodyParts.Add(aBodyPart)
