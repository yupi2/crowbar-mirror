Public Class SourceMdlVertAnim
	...
	Public Property flDelta(ByVal index As Integer) As SourceFloat16
		Get
			Return Me.theDelta(index)
		End Get
		Set(ByVal value As SourceFloat16)
	...
	Public Property flNDelta(ByVal index As Integer) As SourceFloat16
		Get
	...
	Private theDelta(2) As SourceFloat16
	Private theNDelta(2) As SourceFloat16

	Public Sub New()
		For x As Integer = 0 To 2
			Me.theDelta(x) = New SourceFloat16()
		Next
		For x As Integer = 0 To 2
			Me.theNDelta(x) = New SourceFloat16()
		Next
	End Sub
